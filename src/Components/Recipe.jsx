        ...
        <>
            {
                (!item) ? "" : <div className="content">
                    <button style={{color:'blue', margin:'100'}} onClick={()=>navigate(`/`)}>Home Page</button>
                    <div>
                    <img src={item.strMealThumb} alt="" width="600" height="600"  />
                    ...
                    <div className="video">
                        ...
                        100%" height="515" title="recipeVideo"
                            src={`https://www.youtube.com/embed/dFSN47SCQeI`}>
                        </iframe>
                    </div>
